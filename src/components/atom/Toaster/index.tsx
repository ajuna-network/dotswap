  ...
  return (
    <div
      className={classNames(
        "flex w-full max-w-toaster items-center rounded-br-lg rounded-tr-lg border-l-2 p-4 tracking-[0.2px] shadow-toaster-box-shadow dark:rounded-xl dark:rounded-bl-none dark:rounded-tr-none",
        {
    ...
    >
      <div className="flex w-full gap-3">
        ...
        >
          <div className="font-medium dark:font-omnes-bold">{handleToasterHeaderText(type)}</div>
          <div className="text-medium font-normal dark:font-open-sans dark:font-extrabold">{description}</div>
          {blockExplorerLink && blockExplorerLink !== "" && (
            <div className="flex gap-0.5 pt-1">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="cursor-pointer border-b border-solid border-black pb-0.5 font-unbounded-variable text-small leading-tight tracking-[0.06em] text-black text-opacity-90 dark:font-omnes-bold"
              >
