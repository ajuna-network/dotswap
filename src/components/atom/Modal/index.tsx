          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative z-10 transform overflow-hidden rounded-2xl border border-gray-10 bg-white p-[18px] shadow-modal-box-shadow">
                <div className="mb-[6px] flex flex-col items-center border-b border-b-gray-50 pb-[8px] pt-[5px]">
                  ...
                  <div className="flex w-full justify-center font-unbounded-variable text-heading-6 font-bold	leading-[120%]">
                    {title}
                  </div>
                </div>
                {children}
