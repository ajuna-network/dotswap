...
const WithdrawPoolLiquidity = () => {
  ...
  return (
    <div className="flex w-full max-w-[460px] flex-col gap-4">
      <div className="relative flex w-full flex-col items-center gap-1.5 rounded-2xl bg-white p-5 dedswap:rounded-sm dedswap:border-8 dedswap:border-black dedswap:bg-opacity-90">
