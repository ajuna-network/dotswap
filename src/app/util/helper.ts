...
// Fetch Relay Chain balance and set selected chain
...
// Fetch Asset Hub balance and set selected chain
export const fetchAssetHubBalance = async (api: any, setSelectedChain: any) => {
  if (!api) return;
