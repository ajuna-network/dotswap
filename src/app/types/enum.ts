...
export enum ActionType {
  ...
  SET_RELAY_API = "SET_RELAY_API",
  SET_RELAY_PROVIDER = "SET_RELAY_PROVIDER",
  ...
  SET_MESSAGE_QUEUE_PROCESSED_FEE = "SET_MESSAGE_QUEUE_PROCESSED_FEE",
  ...
  SET_NOTIFICATION_TRANSACTION_DETAILS = "SET_NOTIFICATION_TRANSACTION_DETAILS",
  SET_NOTIFICATION_TRANSACTION_FROM = "SET_NOTIFICATION_TRANSACTION_FROM",
  SET_NOTIFICATION_TRANSACTION_FROM_AMOUNT = "SET_NOTIFICATION_TRANSACTION_FROM_AMOUNT",
  SET_NOTIFICATION_TRANSACTION_TO = "SET_NOTIFICATION_TRANSACTION_TO",
  SET_NOTIFICATION_TRANSACTION_TO_AMOUNT = "SET_NOTIFICATION_TRANSACTION_TO_AMOUNT",
  SET_NOTIFICATION_CHAINS_DETAILS = "SET_NOTIFICATION_CHAINS_DETAILS",
  SET_NOTIFICATION_MESSAGE = "SET_NOTIFICATION_MESSAGE",
  SET_NOTIFICATION_LINK = "SET_NOTIFICATION_LINK",
  SET_NOTIFICATION_LINK_TEXT = "SET_NOTIFICATION_LINK_TEXT",
  SET_NOTIFICATION_LINK_HREF = "SET_NOTIFICATION_LINK_HREF",
